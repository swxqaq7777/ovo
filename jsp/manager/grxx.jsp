	...
	<form class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
						...
						<a href="${pageContext.request.contextPath }/manage/toupdate?managerid=${manager.managerid}" class=" text-center btn btn-primary  col-md-offset-4 col-lg-offset-4col-xl-offset-4" role="button">修改</a>
